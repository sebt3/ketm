...
typedef struct _par {
	...
	float x,y;		/* akt. position */
	float xv,yv;		/* bewegungsvektor */
...
void parsys_add(SDL_Surface *src, int xs, int ys, int xp, int yp, int maxspeed, int gangle, float gspeed, int ttl, int fx, int *msg);
void parsys_display();
